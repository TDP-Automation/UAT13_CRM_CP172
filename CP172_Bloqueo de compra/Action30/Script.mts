...
DataTable("s_Resultado","Alta Residencial NPC") ="Fallido"
DataTable("s_Detalle","Alta Residencial NPC") ="Error al consultar servicio web"
DataTable("s_Resultado","Alta Residencial Enviar Orden") ="Fallido"
DataTable("s_Detalle","Alta Residencial Enviar Orden") ="Error al consultar servicio web"
Reporter.ReportEvent micFail, "Fallido","Error consultar servicio Web"
	ExitTestIteration
End If
