...
Sub AltaExpress()
	...
	If UCASE(MetodoEntrega) = "EN TIENDA" Then
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Alta Express (Para WALTHER").JavaList("Metodo de Entrega").Select DataTable("e_MetodoEntrega",dtLocalSheet)
		wait 2
		...
		tiempo=0
			Do
				If (DataTable("s_Detalle", dtLocalSheet)="Por favor rellenar todas las identificaciones de equipos") or (DataTable("s_Detalle", dtLocalSheet)<>"Por favor rellenar todas las identificaciones de equipos") Then
					...
					Dim simDis
					Dim simCard
					simDis=JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").GetCellData ("#1","#1")
					simCard=JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").GetCellData ("#2","#1")
'				  MsgBox simDis
'				  MsgBox simCard
				  Select Case simDis
					Case "Tarjeta SIM"
					   JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#1","#4"
						...
						wait 2
						JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").SetCellData "#1","#4",DataTable("e_IdSIM",dtLocalSheet)
						wait 2
					Case "Dispositivo"
					  ...
					  JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#1","#4"
						...
						shell.SendKeys "{ENTER}"
						wait 2
						JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").SetCellData "#1","#4",DataTable("idDispositivo",dtLocalSheet)
						wait 2
				...
				Select Case simCard
					Case "Tarjeta SIM"
					   JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#2","#4"
						...
						shell.SendKeys "{ENTER}"
						wait 2
						JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").SetCellData "#2","#4",DataTable("e_IdSIM",dtLocalSheet)
						wait 2
					Case "Dispositivo"
					  ...
					  JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").DoubleClickCell "#2","#4"
						...
						shell.SendKeys "{ENTER}"
						wait 2
						JavaWindow("Ejecutivo de interacción").JavaDialog("Buscar: Orden > Solicitar").JavaTable("SearchJTable").SetCellData "#2","#4",DataTable("idDispositivo",dtLocalSheet)
						wait 2
